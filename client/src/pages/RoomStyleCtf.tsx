    ...
    <div className="w-full min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="relative bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <iframe 
            src="https://docs.google.com/forms/d/e/1FAIpQLSeqPLAAmGF8S_VWULkIJJ2s0QIkuE3PkiCogFTTPUCQaslCqQ/viewform?embedded=true" 
        ...
        <div className="text-center mt-4 sm:mt-6 text-xs sm:text-sm text-gray-500">
          <p>
            ...
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSeqPLAAmGF8S_VWULkIJJ2s0QIkuE3PkiCogFTTPUCQaslCqQ/viewform"
              target="_blank"
