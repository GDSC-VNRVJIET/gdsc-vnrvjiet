                      ...
                      <React.Fragment key={rowIndex}>
                        <div className="mb-16">
                          ...
                          {isOpenInRow && person && (() => {
                            ...
                            return (
                              <div
                                className="border border-black mt-10 transition-all duration-300  overflow-hidden shadow-sm"
                              >
                                ...
                                >
                                  ...
                                  <button
                                    ...
                                    className="absolute right-6 text-lg hover:scale-110 transition"
                                  >
                                    ✕
                                  </button>
                                </div>
                                ...
                                <div className={`grid ${gridCols} gap-8 p-8 justify-items-center`}>
                                  ...
                                  {person.coordinators.map((coord, i) => (
                                    ...
                                    >
                                      ...
                                      <p className="text-xs items-center text-gray-500">
                                        Coordinator
                                      </p>
