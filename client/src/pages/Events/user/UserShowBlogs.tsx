...
//   author: string;
//   category: string;
//   isCommunity: string; // This should be a boolean value
//   [key: string]: any;
//   date: string;
// }
...
//           setFilteredBlogs(response.data.payload); // Show all blogs initially
...
//   // Handle clicking on a blog
//   const handleBlogClick = (blogId: string) => {
//     navigate(`/blogs/${blogId}`);
//   };

//   // Filter blogs by community type
...
//                 // Card styling for community blogs
//                 <div
//                   key={blog._id}
...
//                 </div>
//               ) : (
//                 // Default styling for other blogs
//                 <section
//                   key={blog._id}
