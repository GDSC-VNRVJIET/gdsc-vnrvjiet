  ...
  return displayLoader ? (
    ...
    <>
      ...
      <div className="product ml-3 mt-6">
        ...
        <p className="text-center mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-blue-400">
          {states?.description}
        </p>
        <form
        ...
        >
          ...
          <div className="mt-3 ml-3">
            <div className="cursor-pointer">
              <button
                type="submit"
                className="relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-medium text-teal-600 transition duration-300 ease-out border-2 border-teal-500 rounded-full shadow-md group"
              >
