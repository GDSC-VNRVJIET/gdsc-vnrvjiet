    ...
    <>
      ...
      {modal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 px-4">
          <div className="bg-white p-6 rounded-lg shadow-lg w-4/5 max-w-md relative min-w-[280px]">
            <span
              className="absolute top-3 right-3 text-2xl cursor-pointer text-red-500 hover:bg-red-500 hover:text-white hover:rounded-full hover:p-1"
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <WhatsappShareButton
                title={`${states?.name} Register for this amazing event conducted by GDGC VNRVJIET!!`}
              ...
              <TwitterShareButton
                ...
                className="mr-1"
              >
                <FaXTwitter className="rounded-full w-10 h-10 bg-black text-white p-2" />
              </TwitterShareButton>
              <LinkedinShareButton
                summary="Register for this Amazing event conducted by GDGC VNRVJIET !!"
                title={states?.name}
                url={window.location.href}
              >
              ...
              <IoCopyOutline
                className="rounded-full w-12 h-12 p-2 hover:cursor-pointer border border-gray-300 text-gray-600 hover:bg-gray-200"
                onClick={handleCopy}
              />
            </div>
            <p className="text-center lg:text-sm mt-2">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          You have already registered for this event , Check the
                          details again to further process.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Check the registered email to know about the payment
                          and event details
                        </p>
                      </div>
                    </div>
                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          We have reached the maximum registrations for this
                          event.
                        </p>
                      </div>
                    </div>
      ...
      <div className="product mt-6 flex flex-col items-center">
        <div className=" lg:w-4/6 px-4 lg:px-1 p-4 bg-white shadow-lg rounded-xl mt-5 mb-10">
          ...
          <p
            dangerouslySetInnerHTML={{ __html: states?.description }}
            className="text-justify text-md text-gray-600 lg:text-lg mt-5 sm:px-16 mb-2 "
          >
            {/* {states?.description}   */}
          </p>
          <div  onClick={scrollToForm} className="flex flex-col items-center hover:cursor-pointer">
            <p className="text-xl font-semibold">Registration Form</p>
            <motion.div
              animate={{ y: [0, 10, 0] }}
              transition={{ duration: 1, repeat: Infinity, ease: "easeInOut" }}
            >
              <FaChevronDown className="text-2xl text-gray-600 mt-1" />
            </motion.div>
          </div>
        </div>
        {states?.name !== "Blockchain Workshop" ? (
          ...
          >
            {count > 0 ? (
              <>
                <div ref={formRef} className="flex mb-3 ms-4 justify-between items-center">
                  <div className="flex">
                    <div
                ...
                >
                  <div className="w-full mt-3 lg:ml-3 flex flex-wrap space-x-1.5">
                    <div className="relative mt-6 mb-8 ms-2 lg:ms-0 w-full lg:w-[45%] lg:ml-1.5 min-w-[200px] h-10">
                      <input
                        type="text"
                      ...
                      <div className="">
                        ...
                        {errors.rollno?.type === "maxLength" && (
                          <p className="text-red-500">
                            Should be 10 digits, no extra space
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="relative mt-6 mb-8 w-full lg:w-[45%] min-w-[200px] h-10">
                      <label className="ms-1 text-gray-500">Year</label>
                      <select
                    ...
                    <div className="relative mt-6 mb-8 w-full lg:w-[45%] min-w-[200px] h-10">
                      <label className="ms-1 text-gray-500">Section</label>
                      <select
                    ...
                    <div className="w-full lg:w-11/12 mx-auto mt-6">
                      <label htmlFor="interest" className="ms-1 text-gray-500">
                        What interests you to join the event?
                      </label>
                      <textarea
                        {...register("interest")}
              ...
              <div className="flex flex-col justify-center items-center bg-gray-100">
                <div className="bg-white shadow-lg rounded-lg p-10 max-w-md w-full text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    We're sorry, but the registration limit has been reached for
                    this event.
                  </p>
                  <img
