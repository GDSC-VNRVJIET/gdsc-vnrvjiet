    ...
    <div>
      <div className="w-full h-full p-4">
        <div className={`HeroSection flex flex-col bg-cover bg-center bg-no-repeat mt-4 relative ${scrolled ? 'static mt-4' : ''}`}>
          <div className={`relative flex justify-center ${scrolled ? 'static' : ''}`}>
            <video className="lg:w-4/5 sm:w-full animate-fadeIn" autoPlay loop muted>
              <source src={`${process.env.PUBLIC_URL}/banner2.mp4`} type="video/mp4" />
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48" className="w-10 h-10 lg:w-12 lg:h-12">
                ...
                <path fill="url(#grad1)" d="M34.017,41.99l-20,0.019c-4.4,0.004-8.003-3.592-8.008-7.992l-0.019-20	c-0.004-4.4,3.592-8.003,7.992-8.008l20-0.019c4.4-0.004,8.003,3.592,8.008,7.992l0.019,20	C42.014,38.383,38.417,41.986,34.017,41.99z" />
                <radialGradient id="grad2" cx="11.786" cy="5.54" r="29.813" gradientTransform="matrix(1 0 0 .6663 0 1.849)" gradientUnits="userSpaceOnUse">
                  <stop offset="0" stopColor="#4168c9" />
                  <stop offset=".999" stopColor="#4168c9" stopOpacity="0" />
                </radialGradient>
                <path fill="url(#grad2)" d="M34.017,41.99l-20,0.019c-4.4,0.004-8.003-3.592-8.008-7.992l-0.019-20	c-0.004-4.4,3.592-8.003,7.992-8.008l20-0.019c4.4-0.004,8.003,3.592,8.008,7.992l0.019,20	C42.014,38.383,38.417,41.986,34.017,41.99z" />
      ...
      <div className="flex justify-center py-8">
        <button
          ...
          style={selected === 'Workshops' ? workshopActiveStyle : workshopInactiveStyle}
        >
          Workshops
        </button>
        <button
          onClick={() => setSelected('Hackathons')}
          style={selected === 'Hackathons' ? hackathonActiveStyle : hackathonInactiveStyle}
        >
          Hackathons
        </button>
      </div>
      ...
      {selected === 'Workshops' ? (
        ...
        <div>
          <p className="flex justify-center py-4">No Hackathons available</p>
        </div>
      )}
    </div>
  );
