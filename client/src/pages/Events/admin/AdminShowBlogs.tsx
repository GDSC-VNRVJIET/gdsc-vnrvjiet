                ...
                <>
                  <div className="flex flex-col gap-4">
                    ...
                    >
                      ...
                      <option value="Social Media and Design">
                        Social Media and Design
                      </option>
                      <option value="App Development">App Development</option>
                      <option value="Hardware">Hardware</option>
                      <option value="Women-in-Tech">Women in Tech</option>
                      <option value="Testing and Cyber Security">
                ...
                blogs.map((blog) => (
                  ...
                  >
                    <div className="max-w-6xl mx-auto px-8 py-2">
                      <article className="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center cursor-pointer transition-all duration-300 ease-out hover:-translate-y-1 group">
                        <div className="relative block group-hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] rounded-xl p-2">
                          ...
                          ></div>
                          <figure
                            className="relative h-[400px] overflow-hidden transform md:-translate-y-2 xl:-translate-y-4 group-hover:translate-x-0 group-hover:translate-y-0 transition duration-700 ease-out rounded-xl"
                          ...
                          <header className="flex justify-between">
                            ...
                            {showRadioButtons && (
                              <input
                                ...
                                className="text-right z-10 border-8 border-blue-600"
